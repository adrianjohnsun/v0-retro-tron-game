...
export const metadata: Metadata = {
  title: "TRON: Light Cycle Program",
  description: "Enter the Grid and battle CLU in this retro Light Cycle arena game",
  generator: "v0.app",
  icons: {
    icon: [
      {
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_HnQbPrGTxOe?ref=COXKVH"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-b3b7368f-7e03-4521-a08b-e35014be58da').style.display='none'"
